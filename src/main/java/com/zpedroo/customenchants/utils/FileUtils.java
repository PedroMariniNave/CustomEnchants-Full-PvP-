package com.zpedroo.customenchants.utils;
...
public class FileUtils {
    ...
    public String getColoredString(Files file, String path) {
        return ChatColor.translateAlternateColorCodes('&', getString(file, path));
    }
    ...
    public enum Files {
        ...
        THUNDER("thunder", "enchants", "enchants");
